            ...
            {/* Left Column - Benefits */}
                ...
                <div className="space-y-6">
                    ...
                    <h3 className="text-xl font-semibold text-theme-dark mb-4">Small Mailbox</h3>
                        <div className="grid grid-cols-3 gap-4">
                            <div className="text-center p-4 bg-gray-50 rounded-lg">
                                <p className="text-lg font-semibold text-theme-dark">$45 ($15/mo)</p>
                                <p className="text-sm text-theme-gray">3 months</p>
                            </div>
                            <div className="text-center p-4 bg-gray-50 rounded-lg">
                                <p className="text-lg font-semibold text-theme-dark">$78 ($13/mo)</p>
                                <p className="text-sm text-theme-gray">6 months</p>
                            </div>
                            <div className="text-center p-4 bg-gray-50 rounded-lg">
                                <p className="text-lg font-semibold text-theme-dark">$144 ($12/mo)</p>
                    ...
                    <h3 className="text-xl font-semibold text-theme-dark mb-4">Medium Mailbox</h3>
                        <div className="grid grid-cols-3 gap-4">
                            <div className="text-center p-4 bg-gray-50 rounded-lg">
                                <p className="text-lg font-semibold text-theme-dark">$57 ($19/mo)</p>
                                <p className="text-sm text-theme-gray">3 months</p>
                            </div>
                            <div className="text-center p-4 bg-gray-50 rounded-lg">
                                <p className="text-lg font-semibold text-theme-dark">$102 ($17/mo)</p>
                                <p className="text-sm text-theme-gray">6 months</p>
                            </div>
                            <div className="text-center p-4 bg-gray-50 rounded-lg">
                                <p className="text-lg font-semibold text-theme-dark">$192 ($16/mo)</p>
                                <p className="text-sm text-theme-gray">1 year</p>
                            </div>
                        </div>
                    </div>
